...
<title>E-Library | Lend Request List</title>
</head>
<body>
    <div class="container">
      ...
      <div class="content">
        <div class="booklist-table">
            <table class="styled-table">
                ...
                <tbody>
                    <c:forEach var="lendlist" items="${lendlist}">
                    <tr>
                    <td>${lendlist.lendid}</td>
                    <td>${lendlist.userid}</td>
                    <td>${lendlist.bookid}</td>
              <td>
              <a href="approverequest/${lendlist.lendid}" class="approvebutton" style="vertical-align:middle"><span>Approve</span></a>
              <a href="rejectrequest/${lendlist.lendid}" class="rejectbutton" style="vertical-align:middle"><span>Reject</span></a>
                        </td>
                    </tr>
                    </c:forEach>   
                </tbody>
