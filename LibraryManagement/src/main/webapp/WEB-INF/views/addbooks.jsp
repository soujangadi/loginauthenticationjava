...
.addbooksbutton:hover span {
  padding-right: 15px;
}

.addbooksbutton:hover span:after {
  opacity: 1;
  right: 0;
}
input[type=text] {
...
<title>E-Library | Add Books</title>
</head>
<body>
    <div class="container">
    ...
    <div id="navbar">
        <a class="active" href="bookinventory">Book Inventory</a>
      ...
      <div class="content">
        <a href="bookinventory">Back to Books List</a>
        <hr/>
        <span class="userfriendly">
            <div style="text-align: center;">
           <h3 style="color: #009999;">Create New Book</h3>
        </div>
        <br/>
           <label>Book Title</label>
           <label style="margin-left: 450px;">Author Name</label>
           ...
           transition: 0.5s;">
            ...
            <option>Joseph Murphy</option>
            <option>Dale Carnegie</option>
            <option>Martin Dunkerton</option>
            <option>Mark Manson</option>
            <option>Amit Ghule</option>
            <option>Arthur Conan Doyle</option>
           </select> 
            <br/><br/>
