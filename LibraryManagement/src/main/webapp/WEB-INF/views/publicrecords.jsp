...
<title>E-Library | Pulishers List</title>
</head>
<body>
    <div class="container">
    ...
    <div id="navbar">
      ...
      <div class="content">
        <a href="addpublishers">Add Publishers</a>
...
<tr>
<td>${pub.publisherrname}</td>

<td><a href="editPublisher/${pub.publisherid}">Edit</a></td>
<td><a href="deletePublisher/${pub.publisherid}">Delete</a></td>
</tr>
</c:forEach>
            </table>
        </div>
